...
class ReflectionPhase(str, Enum):
    ...
    GEORELATING_ACTOR_GENERATION = "georelating_actor_generation"
    GEORELATING_ACTOR_RETRY_ON_INVALID_OUTPUT = "georelating_actor_retry_on_invalid_output"
    GEORELATING_ACTOR_RETRY_AFTER_FATAL_ERROR = "georelating_actor_retry_after_fatal_error"
    GEORELATING_CRITIC_GENERATION_FOR_INVALID_OUTPUT = "georelating_critic_generation_for_invalid_output"
    GEORELATING_CRITIC_GENERATION_FOR_FATAL_ERRORS = "georelating_critic_generation_for_fatal_errors"
...
class ResolvedToponym(BaseModel):
    ...
    selected_candidate_geonameId: int | None = Field(default=None,
                                                     description="The GeoNames ID of the selected candidate")
...
class GeoRelatingState(GeoCodingState):
    georelating_prompt: str = Field(description="The prompt used to generate the georelating output",
                                    default="")
    georelating_raw_output: AIMessage = Field(description="The raw output of the georelating model",
                                              default=AIMessage(content=""))
    georelated: Dict = Field(description="The parsed and normalized georelating output "
                                         "(center coordinates and affected area)",
                             default={})
    georelating_fatal_errors: List[Error] = Field(description="List of fatal errors in the georelating output",
                                                  default=[])
    georelating_invalid_output_errors: List[Error] = Field(
        description="List of validation errors of the georelating output",
        default=[])
    georelating_critic_prompt: str = Field(description="The prompt used to generate the georelating critic output",
                                           default="")
    georelating_critic_feedback: AIMessage = Field(
        description="The output (feedback) generated by the georelating critic",
        default=AIMessage(content=""))
    georelating_reflected_prompt: str = Field(
        description="The prompt containing actionable feedback by the georelating critic",
        default="")
